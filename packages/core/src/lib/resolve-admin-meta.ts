...
const KeystoneAdminUIListMeta = graphql.object<ListMetaRootVal>()({
  ...
  fields: {
    ...
    itemQueryName: graphql.field({ type: graphql.nonNull(graphql.String) }), // TODO: remove in breaking change
    listQueryName: graphql.field({ type: graphql.nonNull(graphql.String) }), // TODO: remove in breaking change
  },
})
